          ...
          {!isTransferComplete ? (
            <>
                      ...
                      <TabsContent value="account" className="space-y-4 mt-4">
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            <Input id="account-number" placeholder="Enter account number" className="flex-1" />
                            <Button
                              type="button"
                              onClick={() => handleAccountSearch(document.getElementById("account-number").value)}
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="p-4 border rounded-lg">
                          ...
                          <p className="text-sm text-muted-foreground">No transfer fee</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <CardFooter className="flex justify-between">
                {step > 1 ? (
                  <Button variant="outline" onClick={() => setStepAndClearError(step - 1)}>
                    Back
                  </Button>
                ) : (
                ...
                {step === 1 ? (
                  ...
                  <Button onClick={handleVerifyOtp} disabled={otp.some((digit) => !digit) || isVerifying}>
                    {isVerifying ? (
                      <>
